...
well <- st_read("Well_Data/AllWells_spatial/Wells_All.shp")
ces <- st_read("CalEnvironScreen/CESJune2018Update_SHP/CES3June2018Update.shp")
...
head(sort(tract_values$Tract, decreasing=TRUE), 5)
